    ...
    <div className=' flex flex-col gap-1'>

        {
            (activeTopic === "Chats" ? chats : contacts).map((chat,i)=>(
                <div  key={i} className = "flex flex-row items-center gap-1 sm:gap-2 lg:gap-2 py-1 px-1 sm:py-2 sm:px-2 lg:py-3 lg:px-3 rounded-xl cursor-pointer bg-gray-600">
